...
comparison <- data.frame(
  ...
  `Reduced Model` = c(aic_reduced, bic_reduced, rmse_reduced, "N/A") # LRT only tests nested models
)
...
ggplot(data, aes(x = outbreak_count)) +
  geom_bar(fill = "steelblue", color = "black", alpha = 0.8) +  # Add color and transparency
  labs(
    x = "Outbreak Count",
    y = "Frequency"
