...
addresses <- c(
  ...
  "2111 Finch Ave W", "170 Wellesley St E", "3015 Lawrence Ave E", 
  ...
  "225 St George St", "59 Lawson Rd", "710 University Ave", "2 Buchan Crt",
  "351 Christie St", "2881 Eglinton Ave", "130 Dunn Ave", "30 The Queensway",
  "1340 York Mills Rd", "140 Sherway Dr", "3595 Keele St", "877 Sheppard Ave W",
  "9 Neilson Road", "150 Dunn Ave", "3277 St. Clair Ave E", "275 Queens Dr",
  ...
  "740 Pape Ave", "22 Norfinch Dr", "70 Guildwood Pky", "1 Northwestern Ave",
  "825 Coxwell Ave", "45 Brunswick Ave", "700 University Ave", "3197 Lakeshore Blvd W",
  "3770 Sheppard Ave E", "221 Milner Ave", "82 Buttowood Ave", "1800 O'Connor Dr",
  ...
  "3555 Danforth Ave", "35 Elm Grove Ave", "4750 Eglinton Ave W", "2233 Kipling Ave",
  "303 Queens Dr", "2311 McNicoll Ave", "1 Kenton Dr", "1020 McNicoll Ave",
  "777 Royal York Rd", "4001 Leslie Mall", "37 D'Arcy St", "340 McCowan Rd",
  ...
  "1235 Wilson Ave", "745 Castlefield Ave", "555 Finch Ave W", "200 Dawes Rd",
  "707 Ellesmere Rd", "77 Roncesvalles Ave", "8 The Donway", "2411 Lawrence Ave E",
  "187 Wynford Dr", "40 Playfiar Ave", "75 Livingstone Rd", "52 Neilson Dr",
  "5 Resurrection Dr", "1 Overland Dr", "500 Kingston Rd", "4180 Dundas St W",
  "215 Tyrrel Ave", "225 St. George St", "272 St. Clair Ave W", "2025 Finch Ave W",
  "1 Kenton Pl", "305 Cummer Ave", "1145 Albion Rd", "150 Emmett Ave",
  "2 Green Belt Dr", "551 Collins Rd", "70 Richview Rd", "2111 Buchan Crt",
  "3830 Lawren Ave E", "10 Senlac Rd", "2 O'Connor Dr", "495 The West Mall",
  "2005 Lawrence Ave", "71 Fairfox Cres", "2111 Finch Ave", "180 Sheridan Ave",
  "550 Cummer Ave", "307 Finch Ave E", "2245 Lawrence Ave West", "3770 Sheppard Ave East",
  ...
  "3277 St. Clair Ave East", "5 Resurection Rd", "1020 Mcnicoll Ave", "70 Scoffield Dr",
  "1001 Queen St West", "2121 Kingston Rd", "700 Melita Cres", "40 Old Kingston Rd",
  "307 Finch Ave", "14 William Morgan Dr", "2701 Bayview Ave", "1925 Rean Dr",
  "420 The East Mall", "551 Conlins Rd", "1800 O'Connor Drive", "84 Davisville Ave",
  "3277 St Clair Ave E", "34 Middleport Cres", "75 Livingston Rd", "22 Norfinch Drive",
  "95 Humber College Blvd", "4750 Eglinton Ave West", "718 Sheppard Ave", "111 Avenue Rd",
  "3030 Birchmount Rd", "750 Church St", "700 & 720 Mount Pleasant Rd", "1077 Ave Rd",
  "111 Ave Rd", "4251 Dundas St W", "1-3 Kenton Dr", "785 Finch Ave W", "147 Elder St",
  "2311 Mcnicoll Ave"
)
...
# Check if the dataset has 617 rows
if (nrow(data) == 617) {
  message("Test Passed: The dataset has 617 rows.")
} else {
  stop("Test Failed: The dataset does not have 617 rows.")
}
...
if (all(data$outbreak_setting %in% outbreak_setting)) {
...
if (all(data$type_of_outbreak %in% type_of_outbreak)) {
...
if (all(data$causative_agent_1 %in% causative_agent_1)) {
...
if (all(data$institution_address != "" & data$outbreak_setting
        != "" & data$type_of_outbreak != "" & data$causative_agent_1 != "")) {
...
if (all(format(as.Date(data$date_outbreak_began), "%Y") == "2024")) {
